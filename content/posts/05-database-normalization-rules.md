...
대부분의 서비스에서는 **3NF까지** 적용하면 충분합니다. BCNF까지 분해하면 테이블 수가 많아지고 `JOIN`이 늘어나면서 조회 성능이 떨어질 수 있습니다.
...
- **조회 성능 저하** — 테이블이 분리될수록 `JOIN`이 늘어나 읽기 쿼리가 느려질 수 있습니다

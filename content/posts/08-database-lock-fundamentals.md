...
>
> 어떤 상황에서 `@Version`과 `FOR UPDATE` 중 무엇을 고를지까지 보고 싶다면, [낙관적 락 vs 비관적 락 — `@Version`과 `FOR UPDATE`를 고르는 실무 기준](/posts/19-optimistic-vs-pessimistic-lock) 글로 이어서 보는 편이 좋습니다.

...
> **참고:** `@Transactional`은 프록시 기반이라 같은 클래스 내부 호출에서 동작하지 않을 수 있습니다. `TransactionTemplate`을 사용하면 트랜잭션 범위를 코드 레벨에서 명확하게 제어할 수 있고, `isReadOnly = true`로 Hibernate flush 비용도 제거할 수 있습니다.

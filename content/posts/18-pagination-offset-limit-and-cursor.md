...
1. **페이지네이션의 출발점은 `LIMIT`이 아니라 `ORDER BY`입니다** — tie-breaker까지 포함한 결정적인 정렬이 먼저 있어야 합니다
...
4. **성능은 페이지네이션 문법보다 인덱스 설계에 더 크게 좌우됩니다** — 필터, 정렬, tie-breaker를 함께 보고 `EXPLAIN`으로 확인해야 합니다

...
MySQL InnoDB 같은 엔진은 기본 인덱스를 흔히 **B+Tree 계열 구조**로 설명합니다. PostgreSQL은 공식 문서에서 기본 인덱스를 **B-Tree**로 설명합니다. 실무적으로는 둘 다 균형 트리 기반 인덱스라는 점이 중요하며, 여기서는 MySQL InnoDB 관점에서 B+Tree를 중심으로 설명하겠습니다.
